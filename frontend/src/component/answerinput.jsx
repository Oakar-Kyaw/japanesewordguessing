    ...
    return (
        <section className="answer-input flex flex-col w-full p-2">
           <div className="flex flex-row items-center justify-center space-x-4 mb-2 mx-6 mt-2">
            ...
            <div>
              <input type="text" className="min-w-[80px] rounded-full shadow-lg h-8 font-poppins p-4 focus:outline-none  " ref={showAnswer} placeholder="True Answer will show here"  readOnly/>  
            </div>
